/**
 * Remove emojis and other special unicode characters from a string.
 * Preserves regular text, numbers, punctuation, and common symbols.
 */
export function stripEmoji(text: string): string {
  // Remove emoji and other symbol characters, then clean up extra whitespace
  return text
    .replace(
