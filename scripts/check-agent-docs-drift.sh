...
if has_change '^(apps/web/(app|components|lib|prisma|e2e)/|apps/contracts/|scripts/|\.github/workflows/(test|coverage|codeql|doc-gardening)\.yml$|package\.json$|pnpm-workspace\.yaml$|ARCHITECTURE\.md$)'; then
  code_changed=1
fi
