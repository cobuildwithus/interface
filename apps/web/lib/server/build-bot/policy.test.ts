...
describe("build-bot policy", () => {
  ...
  it("rejects ETH transfer above cap", () => {
    setEnv({ BUILD_BOT_MAX_ETH_PER_TX: "0.01" });
  ...
  it("rejects USDC transfer above cap", () => {
    setEnv({ BUILD_BOT_MAX_USDC_PER_TX: "1" });
  ...
  it("rejects transfer when network is not allowlisted", () => {
    setEnv({ BUILD_BOT_ALLOWED_NETWORKS: "base" });
  ...
  it("rejects transfer when recipient is not allowlisted", () => {
    setEnv({ BUILD_BOT_ALLOWED_RECIPIENTS: "0x000000000000000000000000000000000000dead" });
  ...
  it("rejects token transfers for disallowed ERC-20 contracts", () => {
    setEnv({ BUILD_BOT_ALLOWED_CONTRACTS: "0x000000000000000000000000000000000000dead" });
  ...
  it("treats allowlists as case-insensitive", () => {
    setEnv({
      BUILD_BOT_ALLOWED_NETWORKS: "BASE-SEPOLIA",
      BUILD_BOT_ALLOWED_RECIPIENTS: "0X000000000000000000000000000000000000DEAD",
      BUILD_BOT_ALLOWED_CONTRACTS: "0X000000000000000000000000000000000000BEEF",
    });
  ...
  it("rejects tx when selector is not allowlisted", () => {
    setEnv({
      BUILD_BOT_ALLOWED_CONTRACTS: "0x000000000000000000000000000000000000dead",
      BUILD_BOT_ALLOWED_SELECTORS: "0xabcdef01",
    });
  ...
  it("allows tx when contract and selector are allowlisted", () => {
    setEnv({
      BUILD_BOT_ALLOWED_CONTRACTS: "0x000000000000000000000000000000000000dead",
      BUILD_BOT_ALLOWED_SELECTORS: "0x12345678",
    });
  ...
  it("requires allowed networks in strict mode", () => {
    setEnv({
      BUILD_BOT_STRICT: "1",
      BUILD_BOT_MAX_ETH_PER_TX: "0.01",
      BUILD_BOT_MAX_USDC_PER_TX: "1",
    });
    ...
    ).toThrow("Strict mode requires BUILD_BOT_ALLOWED_NETWORKS");
  });
  ...
  it("requires ETH and USDC caps in strict mode", () => {
    ...
    ).toThrow("Strict mode requires BUILD_BOT_MAX_ETH_PER_TX");
    ...
    ).toThrow("Strict mode requires BUILD_BOT_MAX_USDC_PER_TX");
  });
  ...
  it("requires selector allowlist in strict mode when contracts are configured", () => {
    ...
    ).toThrow("Strict mode requires BUILD_BOT_ALLOWED_SELECTORS");
  });

  it("optionally requires recipient allowlist in strict mode", () => {
    setEnv({
      BUILD_BOT_STRICT: "1",
      BUILD_BOT_STRICT_REQUIRE_ALLOWED_RECIPIENTS: "1",
      BUILD_BOT_ALLOWED_NETWORKS: "base-sepolia",
      BUILD_BOT_MAX_ETH_PER_TX: "0.01",
      BUILD_BOT_MAX_USDC_PER_TX: "1",
    });
    ...
    ).toThrow("Strict mode requires BUILD_BOT_ALLOWED_RECIPIENTS");
  });
